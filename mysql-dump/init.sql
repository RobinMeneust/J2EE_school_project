...
INSERT INTO LoyaltyAccount(loyaltyPoints, endDate, idLoyaltyProgram) VALUES(55, STR_TO_DATE('28/10/2023', '%d/%m/%Y'), 1);
INSERT INTO LoyaltyAccount(loyaltyPoints, endDate, idLoyaltyProgram) VALUES(60, STR_TO_DATE('30/10/2023', '%d/%m/%Y'), 1);
INSERT INTO LoyaltyAccount(loyaltyPoints, endDate, idLoyaltyProgram) VALUES(10, STR_TO_DATE('04/12/2023', '%d/%m/%Y'), 1);
INSERT INTO LoyaltyAccount(loyaltyPoints, endDate, idLoyaltyProgram) VALUES(30, STR_TO_DATE('02/12/2023', '%d/%m/%Y'), 1);
...
INSERT INTO Category(name, description) VALUES('default category', 'Default category.');
...
INSERT INTO Product(name, stockQuantity, unitPrice, description, idCategory, imagePath) VALUES('Chess Board', 0, 15, 'A chessboard is a gameboard used to play chess. It consists of 64 squares, 8 rows by 8 columns, on which the chess pieces are placed. It is square in shape and uses two colours of squares, one light and one dark, in a chequered pattern. During play, the board is oriented such that each player\'s near-right corner square is a light square.', 2, 'products/chess.jpg');
INSERT INTO Product(name, stockQuantity, unitPrice, description, idCategory, imagePath) VALUES('UNO cards', 10, 5, 'Uno, stylized as UNO, is a proprietary American shedding-type card game originally developed in 1971 by Merle Robbins in Reading, Ohio, a suburb of Cincinnati, that housed International Games Inc., a gaming company acquired by Mattel on January 23, 1992.\nPlayed with a specially printed deck, the game is derived from the crazy eights family of card games which, in turn, is based on the traditional German game of mau-mau.', 3, 'products/uno_cards.jpg');
INSERT INTO Product(name, stockQuantity, unitPrice, description, idCategory, imagePath) VALUES('Werewolves', 20, 19, 'The Werewolves of Millers Hollow is a card game created by the french authors Philippe des Pallières and Hervé Marly in 2001.\n The game is based on the Russian game Mafia.', 3, 'products/werewolves.jpg');
INSERT INTO Product(name, stockQuantity, unitPrice, description, idCategory, imagePath) VALUES('Catan', 20, 34, 'Catan, previously known as The Settlers of Catan is a board game created by Klaus Teuber in 1995 in Germany.\n Players take on the roles of settlers attempting to build and develop holdings while trading and acquiring resources.', 2, 'products/catan.jpg');
INSERT INTO Product(name, stockQuantity, unitPrice, description, idCategory, imagePath) VALUES('Munchkin', 20, 23, 'Munchkin is a dedicated deck card game written by Steve Jackson and illustrated by John Kovalic.\n 3 to 6 players compete to kill monsters and grab magic items the first to reach level 10 wins.', 3, 'products/munchkin.jpg');
INSERT INTO Product(name, stockQuantity, unitPrice, description, idCategory, imagePath) VALUES('7Wonders', 20, 45, '7wonders is a board game created by Antoine Bauza in 2010. Each player lead one of the 7 great cities of the Ancient World building their city to become the greatest.', 2, 'products/7wonders.jpg');
INSERT INTO Product(name, stockQuantity, unitPrice, description, idCategory, imagePath) VALUES('9*9 Goban', 20, 55, 'A 9*9 Goban. A Goban in a gameboard used to pay Go', 2, 'products/goban.jpg');
INSERT INTO Product(name, stockQuantity, unitPrice, description, idCategory, imagePath) VALUES('Shogi', 20, 45, 'Shogi is a strategy board game. It is one the most popular board games in Japan and is in the same family of games as Western xhess, chanturanga, Indian chess and janggi.', 2, 'products/shogi.jpg');
INSERT INTO Product(name, stockQuantity, unitPrice, description, idCategory, imagePath) VALUES('Playing cards', 100, 5, 'A set of playing cards', 3, 'products/playing_cards.jpg');
INSERT INTO Product(name, stockQuantity, unitPrice, description, idCategory, imagePath) VALUES('Tarot cards', 100, 5, 'A set of tarot cards', 3, 'products/tarot.jpg');
INSERT INTO Product(name, stockQuantity, unitPrice, description, idCategory, imagePath) VALUES('Take 6', 100, 5, 'Take 6! is a card game for 2 to 10 players designed by Wolfgang Kramer in 1994 and published by Amigo Spiele.', 3, 'products/take6.jpg');
INSERT INTO Product(name, stockQuantity, unitPrice, description, idCategory, imagePath) VALUES('Risk', 30, 24, 'Risk is a strategy war game invented in 1957 by Albert Lamorise, a French filmmaker and is one of the most popular board games in history', 2, 'products/risk.jpg');
INSERT INTO Product(name, stockQuantity, unitPrice, description, idCategory, imagePath) VALUES('Ticket to ride', 50, 39.99, 'Ticket to ride is a railway-themed German-style board game designed by Alan R. Moon. Players collect and play train cards to claim train routes across the map. The goal is to create the longest continuous railway and connect distant cities to earn the most points.', 2, 'products/Ticket_to_Ride.jpg');
...
INSERT INTO Product(name, stockQuantity, unitPrice, description, idCategory, imagePath) VALUES('Spot it', 100, 15, 'Spot it is a game in which players have to find symbols in common between two cards.', 3, 'products/spot_it.jpg');
INSERT INTO Product(name, stockQuantity, unitPrice, description, idCategory, imagePath) VALUES('Monopoly', 30, 20, 'Monopoly is a multiplayer themed board game hare players buy and trade properties with the goal of driving their opponents into bankruptcy.', 2, 'products/monopoly.jpg');
INSERT INTO Product(name, stockQuantity, unitPrice, description, idCategory, imagePath) VALUES('Civilization the board game', 30, 75,'Sid Meier Civilization: The Board Game is a 2010 board game created by Kevin Wilson based on the Sid Meier Civilization series of video games.', 2, 'products/Civilization.jpg');
INSERT INTO Product(name, stockQuantity, unitPrice, description, idCategory, imagePath) VALUES('Battleship', 30, 20,'Battleship is a two players strategy game played on ruled grids on which each player fleet of warships are marked.\n The locations of the fleets are concealed from the other player and the objective of the game is to destroy the opposing player fleet', 2, 'products/battleship.jpg');
INSERT INTO Product(name, stockQuantity, unitPrice, description, idCategory, imagePath) VALUES('Connect 4', 200, 11.99,'Connect 4 is a game in which players take turns dropping colored tokens into a six-row, seven-column vertically suspended grid. The objective of the game is to be the first one to form a horizontal, vertical or diagonal line of four of one own tokens.', 2, 'products/connect4.jpg');
