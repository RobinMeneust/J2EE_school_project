								...
								<div class="row">
									...
									<div class="col-sm text-center">
										<a class="text-decoration-none text-body" href="get-product-page?id=${featuredProducts.get(i).getId()}">
											<img style="width: 390px; height: 250px; object-fit: contain;" src="${pageContext.request.contextPath}/${featuredProducts.get(i).getImagePath()}" class="d-block" alt="${featuredProducts.get(i).getName()}_img">
											<div>
