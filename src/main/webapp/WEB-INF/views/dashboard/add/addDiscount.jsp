...
<body>
        ...
        <form id="add-discount-form" name="add-discount-form" action="add-discount" method="post">
            <div class="row mb-3 input-group" id="div-name">
                <div class="col">
                    ...
                    <input type="text" class="form-control ${requestScope.InputError.name != null? 'is-invalid' : ''}" id="name" name="name" aria-describedby="nameHelp" placeholder="Enter discount name" required>
            ...
            <div class="row mb-3 input-group" id="div-date">
                <div class="col">
                    ...
                    <input type="date" class="form-control ${requestScope.InputError.startDate != null? 'is-invalid' : ''}" id="start-date" name="startDate" aria-describedby="startDateHelp" value="">
                    <div class="invalid-feedback">
                ...
                <div class="col">
                    ...
                    <input type="date" class="form-control ${requestScope.InputError.endDate != null? 'is-invalid' : ''}" id="end-date" name="endDate" aria-describedby="endDateHelp" value="">
                    <div class="invalid-feedback">
    ...
    <script>
        $(function()
        {
            ...
            $("form[name='add-discount-form']").validate({
                rules: {
                    name: {
                        required: true,
                        maxlength: 30,
