...
<body>
        ...
        <form id="add-moderator-form" name="add-moderator-form" action="add-moderator" method="post">
            ...
            <div class="row mb-3 input-group" id="div-name">
                <div class="col">
                    ...
                    <input type="text" class="form-control ${requestScope.InputError.firstName != null? 'is-invalid' : ''}" id="first-name" name="firstName" aria-describedby="firstNameHelp" placeholder="Enter first name" required>
                ...
                <div class="col">
                    ...
                    <input type="text" class="form-control ${requestScope.InputError.lastName != null? 'is-invalid' : ''}" id="last-name" name="lastName" aria-describedby="lastNameHelp" placeholder="Enter last name" required>
                    <div class="invalid-feedback">
            ...
            <div class="row mb-3 input-group" id="div-password">
                <div class="col">
                    ...
                    <input type="password" class="form-control ${requestScope.InputError.password != null? 'is-invalid' : ''}" id="password" name="password" aria-describedby="passwordHelp" placeholder="Enter password" required>
                    <div class="invalid-feedback">
            ...
            <div class="row mb-3 input-group" id="div-contact-details">
                <div class="col">
                    ...
                    <input type="email" class="form-control ${requestScope.InputError.email != null? 'is-invalid' : ''}" id="email" name="email" aria-describedby="emailHelp" placeholder="Enter email" required>
                    <div class="invalid-feedback">
                ...
                <div class="col">
                    ...
                    <input type="tel" class="form-control ${requestScope.InputError.phoneNumber != null? 'is-invalid' : ''}" id="phone-number" name="phoneNumber" aria-describedby="phoneNumberHelp" placeholder="Enter phone number">
                    <div class="invalid-feedback">
    ...
    <script>
        $(function()
        {
            ...
            $("form[name='add-moderator-form']").validate({
                rules: {
                    firstName: {
                        required: true,
                        maxlength: 30,
